...
<head>
    ...
    <link rel="icon" href="{{ url('cuba/assets/images/luan.ico') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ url('cuba/assets/images/luan.ico') }}" type="image/x-icon">
    <title>Masuk Aplikasi - MasakEuy</title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7">
                <img class="bg-img-cover bg-center" src="{{ url('cuba/assets/images/login/gambar.jpg') }}"
                    alt="looginpage">
            </div>
                ...
                <div class="login-card">
                    <div class="login-main col-10 col-md-10">
                        <form class="theme-form" method="POST" action="{{ route('login') }}">
                            @csrf
                            <h4>Masuk menggunakan akun MasakEuy</h4>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <button class="btn btn-warning btn-block" type="submit">Masuk sekarang ⇾ </button>
                            </div>
                        </form>
                    </div>
