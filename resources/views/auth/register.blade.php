...
<head>
    ...
    <title>Daftar Akun - MasakEuy</title>
...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7">
                <img class="bg-img-cover bg-center" src="{{url('cuba/assets/images/login/soto.jpg')}}"
                    alt="looginpage">
            </div>
                    ...
                    <div class="login-main col-10 col-md-10">
                        <form method="POST" action="{{route('register')}}" class="theme-form">
                            ...
                            <div class="form-group">
                                <button class="btn btn-warning btn-block mt-4" type="submit">Buat Akun ⇾ </button>
                            </div>
